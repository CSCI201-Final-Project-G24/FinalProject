...
public class MessageConstant {
    ...
    public static final String ADD_ORDERSETTINGLIST_FAIL = "新增预约订单失败";
    public static final String ADD_ORDERSETTINGLIST_SUCCESS = "新增预约订单成功";
    public static final String DELETE_ORDERSETTINGLIST_FAIL = "删除预约订单失败";
    public static final String DELETE_ORDERSETTINGLIST_SUCCESS = "删除预约订单成功";
    public static final String QUERY_ORDERSETTINGLIST_SUCCESS = "查询预约订单成功";
    public static final String QUERY_ORDERSETTINGLIST_FAIL = "查询预约订单失败";
    public static final String EDIT_ORDERSETTINGLIST_FAIL = "编辑预约订单失败";
    public static final String EDIT_ORDERSETTINGLIST_SUCCESS = "编辑预约订单成功";
    ...
    public static final String ADD_USER_FAIL = "add user fail";
    public static final String ADD_USER_SUCCESS = "add user success";
    public static final String DELETE_USER_FAIL = "fail deleting user";
    public static final String DELETE_USER_SUCCESS = "success deleting user";
    ...
    public static final String GET_ROLE_LIST_FAIL = "查询角色数据失败";
    public static final String GET_ROLE_LIST_SUCCESS = "查询角色数据成功";
    public static final String ADD_ROLE_LIST_FAIL = "新增角色数据失败";
    public static final String ADD_ROLE_LIST_SUCCESS = "新增角色数据成功";
    ...
    public static final String GET_PERMISSION_LIST_SUCCESS = "查询权限成功";
    public static final String GET_PERMISSION_LIST_FAIL = "查询权限失败";
    public static final String GET_MENULIST_SUCCESS = "获取菜单列表成功";
    public static final String GET_MENULIST_FAIL = "获取菜单列表失败";
    public static final String ADD_MENULIST_SUCCESS = "增加菜单列表成功";
    public static final String ADD_MENULIST_FAIL = "增加菜单列表失败";
    public static final String DELETE_MENULIST_SUCCESS = "删除菜单列表成功";
    public static final String DELETE_MENULIST_FAIL = "删除菜单列表失败";
    public static final String EDIT_MENULIST_SUCCESS = "编辑菜单列表成功";
    public static final String EDIT_MENULIST_FAIL = "编辑菜单列表失败";
